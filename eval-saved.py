...
#!gdown --id 1jFkJ-pkJ16Fkbli7DXDYjyVx8TFNnp1s #DEV FILE
#!gdown --id 1K8WL6Br6UnVP1QMDW7vaNvywkrtxMeU- #Train witout dev
#!gdown --id 1joxGq6MZxeSf-TBNuYd9gfrzVUTe175y #UNLABELED_50k
...
disc_checkpoint_path = "disc-best.pt"
bert_checkpoint_path = "bert-best.pt"

disc_last_checkpoint_path = "disc-last.pt"
bert_last_checkpoint_path = "bert-last.pt"
...
dev_examples = get_qc_examples(dev_file_name)
...
dev_label_mask = np.ones(len(dev_examples), dtype=bool)
dev_dataloader = generate_data_loader(dev_examples, dev_label_mask, label_map, do_shuffle = False, balance_label_examples = False)
...
##NC
test_nc_label_masks = np.ones(len(test_nc_examples), dtype=bool)
...
file.write("")
file.write("\n")
file.write("Running Test Against Best Saved Model...")
file.write("\n")
...
file.write(" Test Accuracy (BEST SAVED MODEL): {0:.3f}".format(test_accuracy))
file.write("\n")
file.write(" Test F1 (BEST SAVED MODEL): {0:.3f}".format(test_f1))
file.write("\n")
...
for i in range (len(all_preds)):
  confusion_matrix[all_labels_ids[i], all_preds[i]] += 1
file.write("Test Confusion matrix (BEST SAVED MODEL): \n")
file.write(str(confusion_matrix))
file.write("\n")
file.flush()
